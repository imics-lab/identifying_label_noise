...
if __name__ == "__main__":
    # x_filename = "src/datasets/Huawei/Torso_Acc_x.txt"
    # y_filename = "src/datasets/Huawei/Torso_Acc_y.txt"
    # z_filename = "src/datasets/Huawei/Torso_Acc_z.txt"
    #
    label_file = "src/datasets/Huawei/Torso_Acc_labels.csv"
    #
    ...
    #
    # np.savetxt("src/datasets/huawei2_data.csv", data, delimiter=",")
    # np.savetxt("src/datasets/huawei2_features.csv", features, delimiter=",")
    #
    ...
    np.savetxt("src/datasets/huawei2_labels.csv", labels, delimiter=",", fmt="%d")
    np.savetxt("src/datasets/huawei_with_noise2_labels.csv", labels_with_noise, delimiter=",", fmt="%d")
    np.savetxt("src/datasets/huawei_with_noise2_indexes.csv", badIndexes, delimiter=",", fmt="%d")
